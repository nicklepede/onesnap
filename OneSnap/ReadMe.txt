========================================================================
    ACTIVE TEMPLATE LIBRARY : OneSnap Project Overview
========================================================================

AppWizard has created this OneSnap project for you to use as the starting point for
...
OneSnap.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (OneSnap.h)
        GUID definitions                                (OneSnap_i.c)
        A type library                                  (OneSnap.tlb)
        Marshaling code                                 (OneSnap_p.c and dlldata.c)

OneSnap.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in OneSnap.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named OneSnap.pch and a precompiled types file named StdAfx.obj.
...
OneSnapps.vcproj
	...
	dlldata.c, OneSnap_i.c and OneSnap_p.c which are required
